    ...
    return(
        <div>      
            <MedicNavBar></MedicNavBar>
                 ...
                 <p className="font-weight-light text-center searchparagraph"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-vcard" viewBox="0 0 16 16">
        ...
        <div className="search d-flex justify-content-center">
            <form className="row row-cols-lg-auto g-3" onSubmit={handlesubmit}>
	<div className="col-md-2">
		<label className="visually-hidden">Message</label> <input
			type="number" className="form-control" id="inputMessage"
